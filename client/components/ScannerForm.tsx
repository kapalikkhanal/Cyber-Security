  ...
  return (
    <div className="w-full max-w-4xl mx-auto">
      <div className="relative group">
        ...
        <div className={`relative bg-white/10 backdrop-blur-xl border rounded-2xl transition-all duration-300 shadow-2xl ${
          isFocused ? 'border-emerald-500/50 shadow-emerald-500/25' : 'border-white/20'
        }`}>
          <div className="flex items-center p-2">
            ...
            <div className="flex-1 relative">
              ...
              {/* Animated underline */}
              <div className={`absolute bottom-2 left-4 right-4 h-0.5 bg-gradient-to-r from-emerald-400 to-cyan-400 transform origin-left transition-transform duration-300 ${
        ...
        <div className="flex items-center justify-center mt-4 text-sm text-slate-400">
          ...
          <span>Secured with enterprise-grade threat detection</span>
        </div>
      </div>
        ...
        <div className="mt-8 flex flex-col items-center">
          <div className="relative">
            ...
            <div className="w-16 h-16 rounded-full border-4 border-emerald-500/30 relative">
              ...
              <div className="absolute inset-2 rounded-full border-4 border-transparent border-t-cyan-500 animate-spin" style={{ animationDirection: 'reverse', animationDuration: '1.5s' }}></div>
            </div>
          </div>
          
          <div className="mt-4 text-center">
            <p className="text-white font-medium text-lg mb-1">Deep Analysis in Progress</p>
            <p className="text-slate-400 text-sm">Checking multiple threat databases...</p>
          </div>
